...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2026. Már 20. 14:01
...
(4, 2, 'proba', NULL, '2026-03-20', '13:54:00', '2026-03-20', '13:55:00', 'task', 'medium', 'pending', NULL, NULL, 'none', 1, NULL, 60, NULL, '2026-03-20 12:53:11', '2026-03-20 12:53:11');
...
(9, 2, 'asd', '', 'állat', 100.00, '', 'aktív', '2026-03-20 12:56:02', '2026-03-20 12:56:02', '', '', '', '', 0, 0, 1);
...
CREATE TABLE `notifications` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `type` varchar(50) NOT NULL COMMENT 'event_reminder, vet_date, marketplace_new, etc.',
  `title` varchar(255) NOT NULL,
  `message` text NOT NULL,
  `data` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Extra adatok (pl. event_id, animal_id)' CHECK (json_valid(`data`)),
...
CREATE TABLE `notification_settings` (
  ...
  `marketplace_alerts` tinyint(1) DEFAULT 1,
...
INSERT INTO `users` (`id`, `username`, `email`, `password_hash`, `created_at`, `role`, `farm_id`, `phone`, `location`, `bio`, `avatar`, `updated_at`) VALUES
(2, 'alma', 'nagybarni@gmail.com', '$2a$10$7.N2ZVUxidC1EZEdFiML0O2NTYwwScin3x7FmhuC/AlgxFW233m4q', '2026-02-03 09:57:58', 'admin', 1, NULL, NULL, NULL, '/uploads/avatars/avatar-1774008041896-52782495.png', '2026-03-20 12:11:13'),
(4, 'savanyo', 'savanyo.balazs0@gmail.com', '$2a$10$AOYGcgDcMoGt3rCwwW.F9O8a7oPHAYfOZ2v92Lb4drB4cvqy1zWRi', '2026-02-10 09:09:41', 'admin', 1, NULL, NULL, NULL, NULL, '2026-03-20 11:47:46'),
(13, 'Kovajo', 'kovajo@gmail.com', '$2a$10$ty2CEwAR6UPe71rcgxY/uOnsiKGx5NwK6i6lwlSdWuCfbtKeQYQ8C', '2026-03-16 18:13:36', 'owner', 1, NULL, NULL, NULL, NULL, '2026-03-20 11:47:46');
